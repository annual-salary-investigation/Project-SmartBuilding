...
namespace appTemplate
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private void MQTT_CLIENT_MqttMsgPSublishReceived(object sender, MqttMsgPublishEventArgs e)
        {
            ...
            try
            {
                ...
                if (currSensor["Safeguard"] != null)
                {
                    this.Invoke(() =>
                    {
                        var tempValue = currSensor["Safeguard"];

                        try
                        {
                            double degree = Double.Parse(tempValue);

                            Txtstatus.Text = $"{degree}";
                        }
                        catch (Exception ex)
                        {
